...
8. **Develop an admissible heuristic to solve the Maze Problem from Chapter 2
   (Exercise 13).**
    ...
    One thing to note about the maze is that the start is at the bottom of the
    maze, and the goal is at the top. If we define $x$ to be the vertical
    distance travelled, and $H$ to be the height of the maze, then an
    admissible heuristic to solve the maze would be $h(x) = H - x$. This means
    that the higher we are vertically, the closer our heuristic measure is
    from the goal.
